...
public class GridDividerItemDecorationFixed extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDividerItemDecorationFixed(Drawable horizontalDivider, Drawable verticalDivider, int numColumns) {
    ...
    private void drawHorizontalDividers(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < mNumColumns; i++) {
            ...
            // just in case we have less than three items in the RecyclerView
            int parentLeft = 0;
            if (child != null) {
